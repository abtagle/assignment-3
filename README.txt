...
This assignment should run correctly in the standard Linux environment on lab combuters. Before executing the .jar file, ensure that you have the following two files in the same directory as your .jar file
	-wordlist.txt
